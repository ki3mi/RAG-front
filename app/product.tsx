...
export default function ProductComponent() {
    return (
        <div className="w-60 h-80 rounded-lg m-2">
            ...
            <div className="flex items-end bg-black h-80 w-60 z-10 absolute opacity-50 text-white rounded-lg">
                <div className="flex flex-col p-4">
                    <div className="text-xl font-bold">
                        <p>20% off en Teclados</p>
                    </div>
...
export function Product2Component() {
    return (
        <div className="w-40 h-60 rounded-lg m-2">
            <div>
                <img src="/img/teclado.jpg" className="w-40 h-40 object-cover rounded-lg" />
            </div>
            <div className="flex-col h-20 text-xs mt-1">
                <p>Teclado cingon y Mmlon RedDragon Kumara</p>
                {/* categoria */}
